## Normalization code
Process:
1. CUT&RUN data processing: Ran samples through [Raab Lab CUT&RUN pipeline](https://github.com/raab-lab/cut-n-run)  ([cnr.sh](https://github.com/raab-lab/Boltz_2025_Normalization/blob/main/src/cnr.sh) then normalize.sh)
